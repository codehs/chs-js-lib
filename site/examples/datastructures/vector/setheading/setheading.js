...
const tick = () => {
    ...
    secondHandVector.setHeading(secondHandVector.heading() + dAngleSeconds);
    minuteHandVector.setHeading(minuteHandVector.heading() + dAngleMinutes);
    hourHandVector.setHeading(hourHandVector.heading() + dAngleHours);
