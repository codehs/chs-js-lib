...
`;
  ...
  window.readFloat = ConsoleInstance.readFloat.bind(ConsoleInstance);
  window.readBoolean = ConsoleInstance.readBoolean.bind(ConsoleInstance);
  window.readLineAsync = ConsoleInstance.readLineAsync.bind(ConsoleInstance);
  window.readIntAsync = ConsoleInstance.readIntAsync.bind(ConsoleInstance);
  window.readFloatAsync = ConsoleInstance.readFloatAsync.bind(ConsoleInstance);
  window.readBooleanAsync = ConsoleInstance.readBooleanAsync.bind(ConsoleInstance);
